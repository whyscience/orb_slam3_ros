...
namespace ORB_SLAM3
{
                                     ...
                                     Eigen::Vector3f &x3D)
    {
        ...
        // 代码中有用到三角化的地方有：TwoViewReconstruction::Triangulate LocalMapping::CreateNewMapPoints
        // KannalaBrandt8::Triangulate Initializer::Triangulate
        // 见Initializer.cpp的Triangulate函数,A矩阵构建的方式类似，不同的是乘的反对称矩阵那个是像素坐标构成的，而这个是归一化坐标构成的
        // Pc = Tcw*Pw， 左右两面乘Pc的反对称矩阵 [Pc]x * Tcw *Pw = 0
