...
namespace ORB_SLAM3
{
    ...
    int Optimizer::PoseInertialOptimizationLastFrame(Frame *pFrame, bool bRecInit)
    {
        ...
        // 列数 6            3                    3                      3            6           3             3 3
        // -----------------------------------------------------------------------------------------------------------------
        // 行数 Jp1.t * Jp1  Jp1.t * Jv1         Jp1.t * Jg1           Jp1.t * Ja1  Jp1.t * Jp2  Jp1.t * Jv2        0 0
        // |  6 Jv1.t * Jp1  Jv1.t * Jv1         Jv1.t * Jg1           Jv1.t * Ja1  Jv1.t * Jp2  Jv1.t * Jv2        0 0
        // |  3 Jg1.t * Jp1  Jg1.t * Jv1  Jg1.t * Jg1 + Jgr1.t * Jgr1  Jg1.t * Ja1  Jg1.t * Jp2  Jg1.t * Jv2  Jgr1.t *
        // Jgr2   0 |  3 Ja1.t * Jp1  Ja1.t * Jv1         Ja1.t * Jg1           Ja1.t * Ja1  Ja1.t * Jp2  Ja1.t * Jv2 0
        // 0 |  3 Jp2.t * Jp1  Jp2.t * Jv1         Jp2.t * Jg1           Jp2.t * Ja1  Jp2.t * Jp2  Jp2.t * Jv2        0
        // 0 |  6 Jv2.t * Jp1  Jv2.t * Jv1         Jv2.t * Jg1           Jv2.t * Ja1  Jv2.t * Jp2  Jv2.t * Jv2        0
        // 0 |  3
        //     0            0             Jgr2.t * Jgr1                 0            0           0       Jgr2.t * Jgr2
        //     0 |  3 0            0                    0                      0            0           0             0
        //     0 |  3
        // -----------------------------------------------------------------------------------------------------------------
        ...
        // 3              3
        // ---------------------------------------------------------------------------------------------------------------------------------------------------
        // 行数 |  Jp1.t * Jp1  Jp1.t * Jv1         Jp1.t * Jg1                 Jp1.t * Ja1            |  Jp1.t * Jp2
        // Jp1.t * Jv2        0              0        |  6 |  Jv1.t * Jp1  Jv1.t * Jv1         Jv1.t * Jg1 Jv1.t * Ja1
        // |  Jv1.t * Jp2  Jv1.t * Jv2        0              0        |  3 |  Jg1.t * Jp1  Jg1.t * Jv1  Jg1.t * Jg1 +
        // Jgr1.t * Jgr1        Jg1.t * Ja1            |  Jg1.t * Jp2  Jg1.t * Jv2  Jgr1.t * Jgr2        0        |  3
        // |  Ja1.t * Jp1  Ja1.t * Jv1         Ja1.t * Jg1           Ja1.t * Ja1 + Jar1.t * Jar1  |  Ja1.t * Jp2  Ja1.t
        // * Jv2        0       Jar1.t * Jar2   |  3
        // |--------------------------------------------------------------------------------------------------------------------------------------------------
        // |  Jp2.t * Jp1  Jp2.t * Jv1         Jp2.t * Jg1                 Jp2.t * Ja1            |  Jp2.t * Jp2  Jp2.t
        // * Jv2        0              0        |  6 |  Jv2.t * Jp1  Jv2.t * Jv1         Jv2.t * Jg1 Jv2.t * Ja1 | Jv2.t
        // * Jp2  Jv2.t * Jv2        0              0        |  3 |      0            0              Jgr2.t * Jgr1 0 |
        // 0           0       Jgr2.t * Jgr2        0        |  3 |      0            0                    0 Jar2.t *
        // Jar1           |        0           0             0        Jar2.t * Jar2  |  3
        // ---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    */
                                ...
                                const bool bAllPoints)
    {
        ...
        for (int i = 0; i < N; i++)
        {
            ...
            e12->setVertex(
                    0, dynamic_cast<g2o::OptimizableGraph::Vertex *>(optimizer.vertex(id2))); // 2相机坐标系下的三维点
    ...
    /**
     * @brief  LoopClosing::CorrectLoop() 回环矫正时使用，IMU加视觉，全局本质图优化，流程基本与上面
     * OptimizeEssentialGraph 一模一样，同样有严重BUG 优化目标： 地图中所有MP与关键帧
     * @param pMap                当前的map
     * @param pLoopKF             mpLoopMatchedKF 与 mpCurrentKF 匹配的关键帧
     * @param pCurKF              mpCurrentKF 当前关键帧
     * @param NonCorrectedSim3    通过pKFi->GetPose()计算的放NonCorrectedSim3也就是回环前的位姿
                                          ...
                                          vector<KeyFrame *> vpFixedKF, bool *pbStopFlag)
    {
        ...
        if (bDoMore)
        {
            ...
            Verbose::PrintMess("[BA]: First optimization(Huber), there are " + to_string(badMonoMP) +
